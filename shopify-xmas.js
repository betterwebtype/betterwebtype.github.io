...
// $(function() {
  ...
  function generateSelectors(product) {
    var elements = product.options.map(function(option) {
      var optionsHtml = option.values.map(function(value) {
        ...
        console.log(value);
        // var remains;
        if (value == 'No wrapping'){
          desc = "Hardcover edition&#44; cheatsheet&#44; personal note + free shipping."
          price = "54.95";
          // remains = "1/15"
        } else if (value == 'With wrapping'){
          desc = "Hardcover edition&#44; cheatsheet&#44; personal note&#44; wrapped in Christmas wrapping paper + free shipping."
          price = "59.95";
          // remains = "0/5"
        }
  ...
  function attachOnVariantSelectListeners(product) {
    $('.variant-selectors').on('change', '.bookVariant', function(event) {
      ...
      // console.log(value);
      if (value == 'With wrapping'){
        goToSlide(6);
      } else if (value == 'No wrapping'){
        goToSlide(1);
      }
